// Copied, unmodified, from ryanegauthier/liars-ledger's src/lookup.js at
// v0.17.13, so scan.html resolves politician names against the exact same
// dictionary logic (nicknames, aliases, ambiguous-bare-surname handling)
// the extension uses. Do not edit here - fix upstream in the extension
// repo and re-copy. Expects `browser.runtime.getURL` to already be
// shimmed (see js/scan.js) to point at GET /api/politicians-dictionary
// instead of the extension's bundled src/data/politicians.json.
